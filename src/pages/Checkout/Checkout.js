...
import dottedLines from "./dotted-lines.gif";
import inactiveDottedLines from "./inactivedots.png";
import activeDottedLines from "./active-dotss.png";
...
const Checkout = () => {
  ...
  const showConfirmedOrder = () => {
    ...
    fetch(
      "https://evil-oni-default-rtdb.asia-southeast1.firebasedatabase.app/orders.json",
      {
        method: "POST",
        body: JSON.stringify({
          User: userInfo,
          OrderedItems: cartCtx.items,
          CartTotal: finalOrderAmount,
          OrderId: orderId,
        }),
      }
    );
  ...
  // console.log("Validity is :" + cartCtx.items.length);
